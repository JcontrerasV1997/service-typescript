...
exports.deleteUsuario = exports.putUsuario = exports.postUsuario = exports.getUsuariosId = exports.getUsuarios = void 0;
...
const getUsuariosId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const usuarioId = yield usuarios_1.default.findByPk(id);
    if (usuarioId) {
        res.json({
            usuarioId
        });
